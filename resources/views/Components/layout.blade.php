...
<div class="min-h-full">
  <nav class="bg-gray-800">
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              ...
              <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <a href="/contact" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Contact</a>
                <a href="/jobs" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Jobs</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <a href="/" class="block px-4 py-2 text-sm text-white-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Home</a>
        <a href="/contact" class="block px-4 py-2 text-sm text-white-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Contact</a>
        <a href="/jobs" class="block px-4 py-2 text-sm text-white-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Jobs</a>
      </div>
  ...
  <header class="bg-white shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <a href="/jobs/create" class="mt-4 inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
        Create Job
        </a>
    </div>
  </header>
